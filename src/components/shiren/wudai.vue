	...
	<div>
		<section class="mainbox">
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">五代</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/shiren/五代诗人.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
			...
			mychart.setOption({
				...
				tooltip: {
				    ...
				    xAxis: [
				        {
				            type: 'category',
				            data: ['李中', '冯延巳', '李煜', '孙光宪', '和凝', '谭用之', '毛文锡','李珣','顾夐','修睦'],
				            axisTick: {
				                alignWithLabel: true
				            }
				        }
				    ...
				    series: [
				        {
				            ...
				            type: 'bar',
				            barWidth: '40%',
				            data: [301,154,69,61,55,45,38,36,27,27]
				        }
				    ]
			})
		}
