	...
	<div>
		<section class="mainbox">
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">魏晋</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/shiren/魏晋诗人.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
			...
			mychart.setOption({
				...
				tooltip: {
				    ...
				    xAxis: [
				        {
				            type: 'category',
				            data: ['陆机', '陶渊明', '傅玄', '张载', '曹丕', '阮籍', '郭璞','嵇康','张华','潘岳'],
				            axisTick: {
				                alignWithLabel: true
				            }
				        }
				    ...
				    series: [
				        {
				            ...
				            type: 'bar',
				            barWidth: '40%',
				            data: [137,134,120,109,69,61,60,58,51,23]
				        }
				    ]
			})
		}
