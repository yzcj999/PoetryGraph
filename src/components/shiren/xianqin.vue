	...
	<div>
		<section class="mainbox">
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">先秦</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/shiren/先秦诗人.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
			...
			mychart.setOption({
				...
				tooltip: {
				    ...
				    xAxis: [
				        {
				            type: 'category',
				            data: ['左丘明', '屈原', '韩非', '宋玉', '庄周', '公羊高','荀子','李斯','谷梁赤','项羽'],
				            axisTick: {
				                alignWithLabel: true
				            }
				        }
