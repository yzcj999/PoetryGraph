	...
	<div>
		<section class="mainbox">
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">元朝</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/shiren/元代诗人.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
			...
			mychart.setOption({
				...
				tooltip: {
				    ...
				    xAxis: [
				        {
				            type: 'category',
				            data: ['杨维桢', '仇远', '张翥', '王冕', '萨都剌', '耶律楚材', '赵秉文','范梈','贝琼','叶颙'],
				            axisTick: {
				                alignWithLabel: true
				            }
				        }
				    ...
				    series: [
				        {
				            ...
				            type: 'bar',
				            barWidth: '40%',
				            data: [955,870,831,820,775,727,640,626,591,569]
				        }
				    ]
			})
		}
