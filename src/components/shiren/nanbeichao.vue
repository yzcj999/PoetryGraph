	...
	<div>
		<section class="mainbox">
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">南北朝</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/shiren/南北朝诗人.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
			...
			mychart.setOption({
				...
				tooltip: {
				    ...
				    xAxis: [
				        {
				            type: 'category',
				            data: ['庾信', '沈约', '谢朓', '鲍照', '萧纲', '江淹', '何逊','萧衍','吴均','谢灵运'],
				            axisTick: {
				                alignWithLabel: true
				            }
				        }
				    ...
				    series: [
				        {
				            ...
				            type: 'bar',
				            barWidth: '40%',
				            data: [507,426,302,296,277,221,157,155,154,147]
				        }
				    ]
			})
		}
