	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">塞上逢故人</a>
						            <a href="#/primary1" class="tag">从军行</a>
						            <a href="#/primary1" class="tag">渔家傲·秋思</a>
						            <a href="#/primary1" class="tag">秋望</a>
						            <a href="#/primary1" class="tag">杂诗</a>
						            <a href="#/primary1" class="tag">从军行二首</a>
						            <a href="#/primary1" class="tag">出塞作</a>
						            <a href="#/primary1" class="tag">梅花落</a>
						            <a href="#/primary1" class="tag">雁门太守行</a>
						            <a href="#/primary1" class="tag">边城落日</a>
						            <a href="#/primary1" class="tag">逢入京使</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="tobiansai">边塞</el-button>
						<el-button class="btn" round type="mini" @click="tochuci">楚辞</el-button>
						<el-button class="btn" round type="mini" @click="todushu">读书</el-button>
						<el-button class="btn" round type="mini" @click="tominyao">民谣</el-button>
						<el-button class="btn" round type="mini" @click="toshijing">诗经</el-button>
						<el-button class="btn" round type="mini" @click="toyuefu">乐府</el-button>
						<el-button class="btn" round type="mini" @click="tozhanzheng">战争</el-button>
				...
				<h2 style="display: inline-block;">边塞</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		tobiansai:function(){
			this.$router.push('./biansai')
		},
		tochuci:function(){
			this.$router.push('./chuci')
		},
		todushu:function(){
			this.$router.push('./dushu')
		},
		tominyao:function(){
			this.$router.push('./minyao')
		},
		toshijing:function(){
			this.$router.push('./shijing')
		},
		toyuefu:function(){
			this.$router.push('./yuefu')
		},
		tozhanzheng:function(){
			this.$router.push('./zhanzheng')
		},
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/边塞.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
