	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">春望</a>
						            <a href="#/primary1" class="tag">阁夜</a>
						            <a href="#/primary1" class="tag">塞下曲</a>
						            <a href="#/primary1" class="tag">从军行</a>
						            <a href="#/primary1" class="tag">从军行二首</a>
						            <a href="#/primary1" class="tag">出塞</a>
						            <a href="#/primary1" class="tag">雁门太守行</a>
						            <a href="#/primary1" class="tag">边城落日</a>
						            <a href="#/primary1" class="tag">战城南</a>
						            <a href="#/primary1" class="tag">发白马</a>
						            <a href="#/primary1" class="tag">司马将军歌</a>
						            <a href="#/primary1" class="tag">北上行</a>
						            <a href="#/primary1" class="tag">岁暮</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">战争</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/战争.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
