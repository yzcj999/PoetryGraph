	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">渡辽水</a>
						            <a href="#/primary1" class="tag">将进酒</a>
						            <a href="#/primary1" class="tag">古从军行</a>
						            <a href="#/primary1" class="tag">发白马</a>
						            <a href="#/primary1" class="tag">远别离</a>
						            <a href="#/primary1" class="tag">采莲曲</a>
						            <a href="#/primary1" class="tag">长歌行</a>
						            <a href="#/primary1" class="tag">游子吟</a>
						            <a href="#/primary1" class="tag">久别离</a>
						            <a href="#/primary1" class="tag">怨歌行</a>
						            <a href="#/primary1" class="tag">桃源行</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">乐府</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/乐府.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
