	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">九怀</a>
						            <a href="#/primary1" class="tag">哀时命</a>
						            <a href="#/primary1" class="tag">九叹</a>
						            <a href="#/primary1" class="tag">九思</a>
						            <a href="#/primary1" class="tag">九辩</a>
						            <a href="#/primary1" class="tag">刘向</a>
						            <a href="#/primary1" class="tag">东方朔</a>
						            <a href="#/primary1" class="tag">王逸</a>
						            <a href="#/primary1" class="tag">九怀</a>
						            <a href="#/primary1" class="tag">天问</a>
						            <a href="#/primary1" class="tag">九歌</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">楚辞</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/楚辞.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
