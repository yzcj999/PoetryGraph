	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">甫田</a>
						           <a href="#/primary1" class="tag">无衣</a>
						           <a href="#/primary1" class="tag">采苓</a>
						           <a href="#/primary1" class="tag">卢令</a>
						           <a href="#/primary1" class="tag">节南山</a>
						           <a href="#/primary1" class="tag">桃夭</a>
						           <a href="#/primary1" class="tag">终风</a>
						           <a href="#/primary1" class="tag">鹤鸣</a>
						           <a href="#/primary1" class="tag">新台</a>
						           <a href="#/primary1" class="tag">何人斯</a>
						           <a href="#/primary1" class="tag">小旻</a>
						           <a href="#/primary1" class="tag">南有嘉鱼</a>
						           <a href="#/primary1" class="tag">缁衣</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">诗经</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/诗经.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
