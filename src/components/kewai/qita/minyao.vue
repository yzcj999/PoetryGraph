	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">风雨</a>
						            <a href="#/primary1" class="tag">巴女谣</a>
						            <a href="#/primary1" class="tag">君子于役</a>
						            <a href="#/primary1" class="tag">终风</a>
						            <a href="#/primary1" class="tag">南风歌</a>
						            <a href="#/primary1" class="tag">氓</a>
						            <a href="#/primary1" class="tag">静女</a>
						            <a href="#/primary1" class="tag">匈奴歌</a>
						            <a href="#/primary1" class="tag">神鸡童谣</a>
						            <a href="#/primary1" class="tag">鸡鸣歌</a>
						            <a href="#/primary1" class="tag">巴女谣</a>
						            <a href="#/primary1" class="tag">绵州巴歌</a>
						            <a href="#/primary1" class="tag">采葛</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">民谣</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/民谣.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
