	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">柏学士茅屋</a>
						            <a href="#/primary1" class="tag">舟中读书</a>
						            <a href="#/primary1" class="tag">劝学诗</a>
						            <a href="#/primary1" class="tag">读孟尝君传</a>
						            <a href="#/primary1" class="tag">观书有感</a>
						            <a href="#/primary1" class="tag">司马光好学</a>
						            <a href="#/primary1" class="tag">和董传留别</a>
						            <a href="#/primary1" class="tag">夜深</a>
						            <a href="#/primary1" class="tag">夜读兵书</a>
						            <a href="#/primary1" class="tag">颜真卿</a>
						            <a href="#/primary1" class="tag">咏史八首·</a>
						            <a href="#/primary1" class="tag">观书</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">读书</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qita/读书.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
