	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">忆扬州</a>
						            <a href="#/primary1" class="tag">梅花落</a>
						            <a href="#/primary1" class="tag">卖炭翁</a>
						            <a href="#/primary1" class="tag">步虚</a>
						            <a href="#/primary1" class="tag">远师</a>
						            <a href="#/primary1" class="tag">琵琶行</a>
						            <a href="#/primary1" class="tag">秋雨夜眠</a>
						            <a href="#/primary1" class="tag">怨情</a>
						            <a href="#/primary1" class="tag">别离</a>
						            <a href="#/primary1" class="tag">采莲曲</a>
						            <a href="#/primary1" class="tag">牧童词</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">其他人物</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/renwu/人物.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
