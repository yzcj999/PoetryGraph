	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">牧童</a>
						            <a href="#/primary1" class="tag">池上</a>
						            <a href="#/primary1" class="tag">稚子弄冰</a>
						            <a href="#/primary1" class="tag">村晚</a>
						            <a href="#/primary1" class="tag">牧竖</a>
						            <a href="#/primary1" class="tag">牧童逮狼</a>
						            <a href="#/primary1" class="tag">蒲松龄</a>
						            <a href="#/primary1" class="tag">黄庭坚</a>
						            <a href="#/primary1" class="tag">牧童诗</a>
						            <a href="#/primary1" class="tag">舟过安仁</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="toertong">儿童</el-button>
						<el-button class="btn" round type="mini" @click="tolaoshi">老师</el-button>
						<el-button class="btn" round type="mini" @click="tomuqin">母亲</el-button>
						<el-button class="btn" round type="mini" @click="toqitarenwu">其他人物</el-button>
						<div id="search">
				...
				<h2 style="display: inline-block;">儿童</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		toertong:function(){
			this.$router.push('./ertong')
		},
		tolaoshi:function(){
			this.$router.push('./laoshi')
		},
		tomuqin:function(){
			this.$router.push('./muqin')
		},
		toqitarenwu:function(){
			this.$router.push('./qitarenwu')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kewai/renwu/儿童.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
