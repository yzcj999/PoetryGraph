	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">祝父母诗</a>
						           <a href="#/primary1" class="tag">忆母</a>
						           <a href="#/primary1" class="tag">短歌行</a>
						           <a href="#/primary1" class="tag">游子吟</a>
						           <a href="#/primary1" class="tag">孟郊</a>
						           <a href="#/primary1" class="tag">母别子</a>
						           <a href="#/primary1" class="tag">思母</a>
						           <a href="#/primary1" class="tag">狱中上母书</a>
						           <a href="#/primary1" class="tag">将母</a>
						           <a href="#/primary1" class="tag">王安石</a>
						           <a href="#/primary1" class="tag">别老母</a>
						           <a href="#/primary1" class="tag">慈乌夜啼</a>
						           <a href="#/primary1" class="tag">墨萱图</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">母亲</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/renwu/母亲.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
