	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag"></a>
						            <a href="#/primary1" class="tag">唐</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">爱国</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/爱国.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
