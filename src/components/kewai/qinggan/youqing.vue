	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">醉留东野</a>
						            <a href="#/primary1" class="tag">赠友人三首</a>
						            <a href="#/primary1" class="tag">赠汪伦</a>
						            <a href="#/primary1" class="tag">送迁客</a>
						            <a href="#/primary1" class="tag">送别</a>
						            <a href="#/primary1" class="tag">送柴侍御</a>
						            <a href="#/primary1" class="tag">送远曲</a>
						            <a href="#/primary1" class="tag">夜别韦司士</a>
						            <a href="#/primary1" class="tag">赠友人三首</a>
						            <a href="#/primary1" class="tag">送友人</a>
						            <a href="#/primary1" class="tag">送卢主簿</a>
						            <a href="#/primary1" class="tag">山行留客</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">友情</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/友情.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
