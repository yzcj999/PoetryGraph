	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">拔蒲二首</a>
						            <a href="#/primary1" class="tag">作蚕丝</a>
						            <a href="#/primary1" class="tag">登二妃庙</a>
						            <a href="#/primary1" class="tag">春日行</a>
						            <a href="#/primary1" class="tag">四愁诗</a>
						            <a href="#/primary1" class="tag">有所思</a>
						            <a href="#/primary1" class="tag">赠妇诗三首</a>
						            <a href="#/primary1" class="tag">白头吟</a>
						            <a href="#/primary1" class="tag">诀别书</a>
						            <a href="#/primary1" class="tag">定情诗</a>
						            <a href="#/primary1" class="tag">湖州竹枝词</a>
						            <a href="#/primary1" class="tag">七夕</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">爱情</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/爱情.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
