	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">桂州腊夜</a>
						            <a href="#/primary1" class="tag">枫桥夜泊</a>
						            <a href="#/primary1" class="tag">归雁</a>
						            <a href="#/primary1" class="tag">日暮</a>
						            <a href="#/primary1" class="tag">回乡偶书</a>
						            <a href="#/primary1" class="tag">阁夜</a>
						            <a href="#/primary1" class="tag">天边行</a>
						            <a href="#/primary1" class="tag">游九龙潭</a>
						            <a href="#/primary1" class="tag">西江夜行</a>
						            <a href="#/primary1" class="tag">望月有感</a>
						            <a href="#/primary1" class="tag">寒食江畔</a>
						            <a href="#/primary1" class="tag">夜雨</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">思乡</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/思乡.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
