	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">欧阳修苦读</a>
						            <a href="#/primary1" class="tag">铁杵成针</a>
						            <a href="#/primary1" class="tag">勤学</a>
						            <a href="#/primary1" class="tag">过零丁洋</a>
						            <a href="#/primary1" class="tag">满江红·写怀</a>
						            <a href="#/primary1" class="tag">长歌行</a>
						            <a href="#/primary1" class="tag">出师表</a>
						            <a href="#/primary1" class="tag">苔</a>
						            <a href="#/primary1" class="tag">登鹳雀楼</a>
						            <a href="#/primary1" class="tag">劝学</a>
						            <a href="#/primary1" class="tag">行路难</a>
						            <a href="#/primary1" class="tag">始闻秋风</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">励志</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/励志.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
