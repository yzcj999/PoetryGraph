	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">别薛华</a>
						            <a href="#/primary1" class="tag">送人游塞</a>
						            <a href="#/primary1" class="tag">送人游塞</a>
						            <a href="#/primary1" class="tag">送人东游</a>
						            <a href="#/primary1" class="tag">冬夜送人</a>
						            <a href="#/primary1" class="tag">南邻</a>
						            <a href="#/primary1" class="tag">春送僧</a>
						            <a href="#/primary1" class="tag">赤壁歌送别</a>
						            <a href="#/primary1" class="tag">送杨子</a>
						            <a href="#/primary1" class="tag">送卢主簿</a>
						            <a href="#/primary1" class="tag">送人东游</a>
						            <a href="#/primary1" class="tag">送友人南归</a>
						            <a href="#/primary1" class="tag">九日送别</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">送别</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/送别.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
