	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">在北题壁</a>
						            <a href="#/primary1" class="tag">踏莎行·春暮</a>
						            <a href="#/primary1" class="tag">夜书所见</a>
						            <a href="#/primary1" class="tag">在燕京作</a>
						            <a href="#/primary1" class="tag">水龙吟·秋兴</a>
						            <a href="#/primary1" class="tag">春日</a>
						            <a href="#/primary1" class="tag">解连环·秋情</a>
						            <a href="#/primary1" class="tag">将母</a>
						            <a href="#/primary1" class="tag">玉楼春·春恨</a>
						            <a href="#/primary1" class="tag">满路花·冬</a>
						            <a href="#/primary1" class="tag">钓雪亭</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">思念</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/思念.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
