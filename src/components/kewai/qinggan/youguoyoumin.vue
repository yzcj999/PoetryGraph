	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">平陵东</a>
						            <a href="#/primary1" class="tag">秋望</a>
						            <a href="#/primary1" class="tag">旱云赋</a>
						            <a href="#/primary1" class="tag">扶风歌</a>
						            <a href="#/primary1" class="tag">冀州道中</a>
						            <a href="#/primary1" class="tag">秋兴八首</a>
						            <a href="#/primary1" class="tag">春望</a>
						            <a href="#/primary1" class="tag">去蜀</a>
						            <a href="#/primary1" class="tag">登楼</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">忧国忧民</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/忧国忧民.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
