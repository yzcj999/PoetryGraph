	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">今别离</a>
						            <a href="#/primary1" class="tag">七夕二首</a>
						            <a href="#/primary1" class="tag">兰亭集序 </a>
						            <a href="#/primary1" class="tag">客从远方来</a>
						            <a href="#/primary1" class="tag">留别妻</a>
						            <a href="#/primary1" class="tag">河传·棹举</a>
						            <a href="#/primary1" class="tag">凭栏人·闺怨</a>
						            <a href="#/primary1" class="tag">石城乐</a>
						            <a href="#/primary1" class="tag">舟中望月</a>
						            <a href="#/primary1" class="tag">卜算子·答施</a>
						            <a href="#/primary1" class="tag">示长安君</a>
						            <a href="#/primary1" class="tag">别宋常侍</a>
						            <a href="#/primary1" class="tag">别云间</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">离别</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/qinggan/离别.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
