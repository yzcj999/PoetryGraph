	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">玉漏迟·咏怀</a>
						            <a href="#/primary1" class="tag">元好问</a>
						            <a href="#/primary1" class="tag">如意娘</a>
						            <a href="#/primary1" class="tag">已凉</a>
						            <a href="#/primary1" class="tag">温庭筠</a>
						            <a href="#/primary1" class="tag">梦江南·千万恨</a>
						            <a href="#/primary1" class="tag">白居易</a>
						            <a href="#/primary1" class="tag">长相思·汴水流</a>
						            <a href="#/primary1" class="tag">张大烈</a>
						            <a href="#/primary1" class="tag">阮郎归·立夏</a>
						            <a href="#/primary1" class="tag">叶小鸾</a>
						            <a href="#/primary1" class="tag">浣溪沙·初夏</a>
						            <a href="#/primary1" class="tag">清平乐·咏雨</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">婉约</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/婉约.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
