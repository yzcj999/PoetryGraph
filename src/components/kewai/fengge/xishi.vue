	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">长歌行</a>
						            <a href="#/primary1" class="tag">汉乐府</a>
						            <a href="#/primary1" class="tag">颜真卿</a>
						            <a href="#/primary1" class="tag">劝学</a>
						            <a href="#/primary1" class="tag">苏轼</a>
						            <a href="#/primary1" class="tag">守岁</a>
						            <a href="#/primary1" class="tag">春晓</a>
						            <a href="#/primary1" class="tag">钱福</a>
						            <a href="#/primary1" class="tag">明日歌</a>
						            <a href="#/primary1" class="tag">短歌行</a>
						            <a href="#/primary1" class="tag">王建</a>
						            <a href="#/primary1" class="tag">杜秋娘</a>
						            <a href="#/primary1" class="tag">金缕衣</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">惜时</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/惜时.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
