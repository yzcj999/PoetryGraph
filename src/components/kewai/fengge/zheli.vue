	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">苏麟</a>
						            <a href="#/primary1" class="tag">断句</a>
						            <a href="#/primary1" class="tag">秋日偶成</a>
						            <a href="#/primary1" class="tag">登飞来峰</a>
						            <a href="#/primary1" class="tag">春宵</a>
						            <a href="#/primary1" class="tag">掩耳盗铃</a>
						            <a href="#/primary1" class="tag">墨子</a>
						            <a href="#/primary1" class="tag">兼爱</a>
						            <a href="#/primary1" class="tag">庄周</a>
						            <a href="#/primary1" class="tag">庖丁解牛</a>
						            <a href="#/primary1" class="tag">曹刿论战</a>
						            <a href="#/primary1" class="tag">两小儿辩日</a>
						            <a href="#/primary1" class="tag">观德亭记</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">哲理</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/哲理.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
