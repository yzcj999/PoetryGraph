	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">王冕</a>
						            <a href="#/primary1" class="tag">梅花</a>
						            <a href="#/primary1" class="tag">墨梅</a>
						            <a href="#/primary1" class="tag">秋莲</a>
						            <a href="#/primary1" class="tag">刘因</a>
						            <a href="#/primary1" class="tag">观梅有感</a>
						            <a href="#/primary1" class="tag">于谦</a>
						            <a href="#/primary1" class="tag">石灰吟</a>
						            <a href="#/primary1" class="tag">一剪梅·咏柳</a>
						            <a href="#/primary1" class="tag">陆容</a>
						            <a href="#/primary1" class="tag">咏竹五首</a>
						            <a href="#/primary1" class="tag">卜算子·咏梅</a>
						            <a href="#/primary1" class="tag">青松</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">咏物</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/咏物.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
