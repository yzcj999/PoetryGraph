	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">王翰</a>
						           <a href="#/primary1" class="tag">凉州词</a>
						           <a href="#/primary1" class="tag">李白</a>
						           <a href="#/primary1" class="tag">梁园吟</a>
						           <a href="#/primary1" class="tag">沁园春·恨</a>
						           <a href="#/primary1" class="tag">夷门歌</a>
						           <a href="#/primary1" class="tag">王维</a>
						           <a href="#/primary1" class="tag">一剪梅·咏柳</a>
						           <a href="#/primary1" class="tag">沁园春·观潮</a>
						           <a href="#/primary1" class="tag">陈维崧</a>
						           <a href="#/primary1" class="tag">醉落魄·咏鹰</a>
						           <a href="#/primary1" class="tag">纳兰性德</a>
						           <a href="#/primary1" class="tag">蝶恋花·出塞</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">豪放</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/豪放.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
