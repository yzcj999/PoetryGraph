	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">欧阳修</a>
						           <a href="#/primary1" class="tag">醉翁亭记</a>
						           <a href="#/primary1" class="tag">翁卷</a>
						           <a href="#/primary1" class="tag">山雨</a>
						           <a href="#/primary1" class="tag">春日偶成</a>
						           <a href="#/primary1" class="tag">程颢</a>
						           <a href="#/primary1" class="tag">春游</a>
						           <a href="#/primary1" class="tag">王令</a>
						           <a href="#/primary1" class="tag">李清照</a>
						           <a href="#/primary1" class="tag">偶成</a>
						           <a href="#/primary1" class="tag">春残</a>
						           <a href="#/primary1" class="tag">朱熹</a>
						           <a href="#/primary1" class="tag">秋月</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="toguiyuan">闺怨</el-button>
						<el-button class="btn" round type="mini" @click="tohaofang">豪放</el-button>
						<el-button class="btn" round type="mini" @click="tohuaigu">怀古</el-button>
						<el-button class="btn" round type="mini" @click="toshuqing">抒情</el-button>
						<el-button class="btn" round type="mini" @click="towanyue">婉约</el-button>
						<el-button class="btn" round type="mini" @click="toxishi">惜时</el-button>
						<el-button class="btn" round type="mini" @click="toyongwu">咏物</el-button>
						<el-button class="btn" round type="mini" @click="tozheli">哲理</el-button>
					</div>
					<div id="search">
				...
				<h2 style="display: inline-block;">抒情</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		toguiyuan:function(){
			this.$router.push('./guiyuan')
		},
		tohaofang:function(){
			this.$router.push('./haofang')
		},
		tohuaigu:function(){
			this.$router.push('./huaigu')
		},
		toshuqing:function(){
			this.$router.push('./shuqing')
		},
		towanyue:function(){
			this.$router.push('./wanyue')
		},
		toxishi:function(){
			this.$router.push('./xishi')
		},
		toyongwu:function(){
			this.$router.push('./yongwu')
		},
		tozheli:function(){
			this.$router.push('./zheli')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kewai/fengge/抒情.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
					...
					function init(data){
						...
						var force = d3.layout.force()
							...
							.linkDistance(180) //设定关系连线的长度
							.charge(-500) //节点间的相互作用力
							.on("tick", tick)
							.start(); //开始引力作用
