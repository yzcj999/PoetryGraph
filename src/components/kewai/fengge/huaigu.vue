	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">蝶恋花</a>
						            <a href="#/primary1" class="tag">文征明</a>
						            <a href="#/primary1" class="tag">满江红</a>
						            <a href="#/primary1" class="tag">王世贞</a>
						            <a href="#/primary1" class="tag">登太白楼</a>
						            <a href="#/primary1" class="tag">李梦阳</a>
						            <a href="#/primary1" class="tag">秋望</a>
						            <a href="#/primary1" class="tag">李商隐</a>
						            <a href="#/primary1" class="tag">于易水送别</a>
						            <a href="#/primary1" class="tag">泊秦淮</a>
						            <a href="#/primary1" class="tag">杜牧</a>
						            <a href="#/primary1" class="tag">黄鹤楼</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">怀古</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/怀古.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
