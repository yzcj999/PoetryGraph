	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">春怨</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">王维</a>
						            <a href="#/primary1" class="tag">早春行</a>
						            <a href="#/primary1" class="tag">李益</a>
						            <a href="#/primary1" class="tag">宫怨</a>
						            <a href="#/primary1" class="tag">江南曲</a>
						            <a href="#/primary1" class="tag">曹植</a>
						            <a href="#/primary1" class="tag">七哀</a>
						            <a href="#/primary1" class="tag">谢灵运</a>
						            <a href="#/primary1" class="tag">燕歌行</a>
						            <a href="#/primary1" class="tag">施耐庵</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">闺怨</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/fengge/闺怨.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
