	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">江城子</a>
						            <a href="#/primary1" class="tag">水调歌头</a>
						            <a href="#/primary1" class="tag">西江月</a>
									<a href="#/primary1" class="tag">菩萨蛮</a>
									<a href="#/primary1" class="tag">杨万里</a>
									<a href="#/primary1" class="tag">范仲淹</a>
									<a href="#/primary1" class="tag">欧阳修</a>
									<a href="#/primary1" class="tag">晏殊</a>
									<a href="#/primary1" class="tag">秦观</a>
						            <a href="#/primary1" class="tag">陆游</a>
						            <a href="#/primary1" class="tag">卜算子·咏梅</a>
						            <a href="#/primary1" class="tag">王安石</a>
						            <a href="#/primary1" class="tag">晏几道</a>
						            <a href="#/primary1" class="tag">鹧鸪天</a>
						            <a href="#/primary1" class="tag">蝶恋花</a>
						            <a href="#/primary1" class="tag">念奴娇·赤壁怀古</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="totang">唐诗三百首</el-button>
						<el-button class="btn" round type="mini" @click="tosong">宋词三百首</el-button>
						<div id="search">
				...
				<h2 style="display: inline-block;">宋词三百首</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
			...
			$(document).ready(function(){
				setTimeout(function(){
					...
					document.addEventListener('mousemove', function(e) {
					     ...
					     angleY = 2 * (e.clientX/ document.body.offsetWidth() - 0.5) * speed  * _baseAngle;
					     angleX = 2 * (e.clientY/ document.body.offsetHeight() - 0.5) * speed  * _baseAngle;
		...
		totang:function(){
			this.$router.push('./tang300')
		},
		tosong:function(){
			this.$router.push('./song300')
		},
		...
		initGraph(){
					...
					d3.json("static/json/宋词三百首.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
		...
		initPie(){
            ...
            title: {
						    ...
						    series: [
						        {
						            ...
						            data: [
						                {value:16, name: '辛弃疾'},
						                {value: 16, name: '苏轼'},
						                {value: 14, name: '李清照', selected: true}
						            ]
						        },
						        {
						            name: '诗词数量',
		            ...
		            legend: {
		                data: ['辛弃疾','苏轼','李煜','李清照','姜夔','秦观','周邦彦','韦庄'],
		                top: 'bottom'
		            },
