	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">行路难</a>
									...
									<a href="#/primary1" class="tag">陈子昂</a>
									<a href="#/primary1" class="tag">王勃</a>
									<a href="#/primary1" class="tag">岑参</a>
									<a href="#/primary1" class="tag">王之涣</a>
									<a href="#/primary1" class="tag">刘禹锡</a>
									<a href="#/primary1" class="tag">望岳</a>
						            <a href="#/primary1" class="tag">旅夜抒怀</a>
						            <a href="#/primary1" class="tag">野望</a>
						            ...
						            <a href="#/primary1" class="tag">送杜少府之任蜀州</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">唐诗三百首</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/唐诗三百首.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
		...
		initPie(){
            ...
            title: {
						    ...
						    series: [
						        {
						            ...
						            data: [
						                {value:29, name: '王维'},
						                {value: 24, name: '李商隐'},
						                {value: 34, name: '李白', selected: true}
						            ]
						        },
						        {
						            name: '诗词数量',
		            ...
		            legend: {
		                data: ['王维','李商隐','李白','杜甫','韦应物','孟浩然','柳长卿','杜牧'],
		                top: 'bottom'
		            },
