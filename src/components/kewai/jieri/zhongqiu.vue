	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">洞仙歌·中秋</a>
						            <a href="#/primary1" class="tag">十五夜望月</a>
						            <a href="#/primary1" class="tag">中秋玩月</a>
						            <a href="#/primary1" class="tag">琵琶仙·中秋</a>
						            <a href="#/primary1" class="tag">纳兰性德</a>
						            <a href="#/primary1" class="tag">洞仙歌·中秋</a>
						            <a href="#/primary1" class="tag">中秋对月</a>
						            <a href="#/primary1" class="tag">曹松</a>
						            <a href="#/primary1" class="tag">虎丘中秋夜</a>
						            <a href="#/primary1" class="tag">折桂令·中秋</a>
						            <a href="#/primary1" class="tag">中秋月</a>
						            <a href="#/primary1" class="tag">孟浩然</a>
						            <a href="#/primary1" class="tag">中秋</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">中秋</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/中秋.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
