	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">端午</a>
						            <a href="#/primary1" class="tag">李隆基</a>
						            <a href="#/primary1" class="tag">同州端午</a>
						            <a href="#/primary1" class="tag">己酉端午</a>
						            <a href="#/primary1" class="tag">屈原塔</a>
						            <a href="#/primary1" class="tag">端午三首</a>
						            <a href="#/primary1" class="tag">贺新郎·端午</a>
						            <a href="#/primary1" class="tag">浣溪沙·端午</a>
						            <a href="#/primary1" class="tag">屈原塔</a>
						            <a href="#/primary1" class="tag">苏轼</a>
						            <a href="#/primary1" class="tag">乙卯重五诗</a>
						            <a href="#/primary1" class="tag">端午三首</a>
						            <a href="#/primary1" class="tag">午日观竞渡</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">端午</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/端午.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
