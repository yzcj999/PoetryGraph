	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">行香子·七夕</a>
						            <a href="#/primary1" class="tag">诉衷情·七夕</a>
						            <a href="#/primary1" class="tag">菩萨蛮·七夕</a>
						            <a href="#/primary1" class="tag">七夕歌</a>
						            <a href="#/primary1" class="tag">辛未七夕</a>
						            <a href="#/primary1" class="tag">七夕曲</a>
						            <a href="#/primary1" class="tag">李贺</a>
						            <a href="#/primary1" class="tag">孟浩然</a>
						            <a href="#/primary1" class="tag">七夕穿针</a>
						            <a href="#/primary1" class="tag">柳恽</a>
						            <a href="#/primary1" class="tag">柳梢青·七夕</a>
						            <a href="#/primary1" class="tag">范成大</a>
						            <a href="#/primary1" class="tag">鹊桥仙·七夕</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">七夕</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/七夕.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
