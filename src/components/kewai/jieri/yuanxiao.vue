	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">正月十五夜</a>
						            <a href="#/primary1" class="tag">汴京元夕</a>
						            <a href="#/primary1" class="tag">观灯乐行</a>
						            <a href="#/primary1" class="tag">京都元夕</a>
						            <a href="#/primary1" class="tag">元好问</a>
						            <a href="#/primary1" class="tag">元夕无月</a>
						            <a href="#/primary1" class="tag">上元竹枝词</a>
						            <a href="#/primary1" class="tag">古蟾宫·元宵</a>
						            <a href="#/primary1" class="tag">观灯乐行</a>
						            <a href="#/primary1" class="tag">符曾</a>
						            <a href="#/primary1" class="tag">唐寅</a>
						            <a href="#/primary1" class="tag">李梦阳</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">元宵</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/元宵.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
