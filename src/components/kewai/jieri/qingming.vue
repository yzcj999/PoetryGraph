	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">清明日对酒</a>
						            <a href="#/primary1" class="tag">清明日对酒</a>
						            <a href="#/primary1" class="tag">清明即事</a>
						            <a href="#/primary1" class="tag">长安清明</a>
						            <a href="#/primary1" class="tag">黄庭坚</a>
						            <a href="#/primary1" class="tag">范成大</a>
						            <a href="#/primary1" class="tag">韦庄</a>
						            <a href="#/primary1" class="tag">温庭筠</a>
						            <a href="#/primary1" class="tag">清明</a>
						            <a href="#/primary1" class="tag">清明日</a>
						            <a href="#/primary1" class="tag">清明二首</a>
						            <a href="#/primary1" class="tag">郊行即事</a>
						            <a href="#/primary1" class="tag">壬戌清明作</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">清明</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/清明.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
