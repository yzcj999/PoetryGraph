	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">关山月</a>
						            <a href="#/primary1" class="tag">寒食野望吟</a>
						            <a href="#/primary1" class="tag">已酉端午</a>
						            <a href="#/primary1" class="tag">西江月</a>
						            <a href="#/primary1" class="tag">阳关曲</a>
						            <a href="#/primary1" class="tag">青玉案·元夕</a>
						            <a href="#/primary1" class="tag">观灯乐行</a>
						            <a href="#/primary1" class="tag">田家元日</a>
						            <a href="#/primary1" class="tag">月夜忆舍弟</a>
						            <a href="#/primary1" class="tag">古朗月行</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">其他节日</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/节日.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
