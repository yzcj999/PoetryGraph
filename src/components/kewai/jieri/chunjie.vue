	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">高阳台·除夜</a>
						            <a href="#/primary1" class="tag">韩疁</a>
						            <a href="#/primary1" class="tag">辛弃疾</a>
						            <a href="#/primary1" class="tag">除夜雪</a>
						            <a href="#/primary1" class="tag">除夜</a>
						            <a href="#/primary1" class="tag">文天祥</a>
						            <a href="#/primary1" class="tag">守岁</a>
						            <a href="#/primary1" class="tag">苏轼</a>
						            <a href="#/primary1" class="tag">元日</a>
						            <a href="#/primary1" class="tag">岁夜咏怀</a>
						            <a href="#/primary1" class="tag">除夜作</a>
						            <a href="#/primary1" class="tag">拜年</a>
						            <a href="#/primary1" class="tag">客中除夕</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">春节</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/春节.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
