	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">赵时春</a>
						            <a href="#/primary1" class="tag">原州九日</a>
						            <a href="#/primary1" class="tag">西夏重阳</a>
						            <a href="#/primary1" class="tag">采桑子·九日</a>
						            <a href="#/primary1" class="tag">九日水阁</a>
						            <a href="#/primary1" class="tag">西夏重阳</a>
						            <a href="#/primary1" class="tag">王逊</a>
						            <a href="#/primary1" class="tag">九日闲居</a>
						            <a href="#/primary1" class="tag">风入松·九日</a>
						            <a href="#/primary1" class="tag">张可久</a>
						            <a href="#/primary1" class="tag">定风波·重阳</a>
						            <a href="#/primary1" class="tag">九日寄岑参</a>
						            <a href="#/primary1" class="tag">秋瑾</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">重阳</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jieri/重阳.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
