	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">初夏游张园</a>
						            <a href="#/primary1" class="tag">夏日</a>
						            <a href="#/primary1" class="tag">初夏江村</a>
						            <a href="#/primary1" class="tag">谢灵运</a>
						            <a href="#/primary1" class="tag">夏夜</a>
						            <a href="#/primary1" class="tag">李商隐</a>
						            <a href="#/primary1" class="tag">乐游原</a>
						            <a href="#/primary1" class="tag">暑旱苦热</a>
						            <a href="#/primary1" class="tag">北塘避暑</a>
						            <a href="#/primary1" class="tag">喜晴</a>
						            <a href="#/primary1" class="tag">幽居初夏</a>
						            <a href="#/primary1" class="tag">村居初夏</a>
						            <a href="#/primary1" class="tag">客中初夏</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">夏天</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jijie/夏天.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
