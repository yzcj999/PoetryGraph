	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">冬柳</a>
						            <a href="#/primary1" class="tag">雪梅</a>
						            <a href="#/primary1" class="tag">天净沙·冬</a>
						            <a href="#/primary1" class="tag">江雪</a>
						            <a href="#/primary1" class="tag">悲青坂</a>
						            <a href="#/primary1" class="tag">苦寒吟</a>
						            <a href="#/primary1" class="tag">洛桥晚望</a>
						            <a href="#/primary1" class="tag">望蓟门</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">北风行</a>
						            <a href="#/primary1" class="tag">冬日归旧山</a>
						            <a href="#/primary1" class="tag">昼夜乐·冬</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">冬天</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jijie/冬天.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
