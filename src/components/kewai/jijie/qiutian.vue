	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">秋雨夜眠</a>
						            <a href="#/primary1" class="tag">雨后秋凉</a>
						            <a href="#/primary1" class="tag">微雨夜行</a>
						            <a href="#/primary1" class="tag">枫桥夜泊</a>
						            <a href="#/primary1" class="tag">在军登城楼</a>
						            <a href="#/primary1" class="tag">古怨别</a>
						            <a href="#/primary1" class="tag">齐安郡晚秋</a>
						            <a href="#/primary1" class="tag">早秋客舍</a>
						            <a href="#/primary1" class="tag">早秋山中作</a>
						            <a href="#/primary1" class="tag">南山田中行</a>
						            <a href="#/primary1" class="tag">落叶</a>
						            <a href="#/primary1" class="tag">秋晚登古城</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="tochuntian">春天</el-button>
						<el-button class="btn" round type="mini" @click="toxiatian">夏天</el-button>
						<el-button class="btn" round type="mini" @click="toqiutian">秋天</el-button>
						<el-button class="btn" round type="mini" @click="todongtian">冬天</el-button>
					</div>
					<div id="search">
				...
				<h2 style="display: inline-block;">秋天</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		tochuntian:function(){
			this.$router.push('./chuntian')
		},
		toxiatian:function(){
			this.$router.push('./xiatian')
		},
		toqiutian:function(){
			this.$router.push('./qiutian')
		},
		todongtian:function(){
			this.$router.push('./dongtian')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kewai/jijie/秋天.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
