	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">闺怨</a>
						            <a href="#/primary1" class="tag">春晓</a>
						            <a href="#/primary1" class="tag">春雨</a>
						            <a href="#/primary1" class="tag">春生</a>
						            <a href="#/primary1" class="tag">春题湖上</a>
						            <a href="#/primary1" class="tag">和乐天春词</a>
						            <a href="#/primary1" class="tag">落花落</a>
						            <a href="#/primary1" class="tag">春日寄怀</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">春天</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jijie/春天.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
