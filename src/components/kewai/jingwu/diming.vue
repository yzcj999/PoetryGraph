	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">送人游吴</a>
						           <a href="#/primary1" class="tag">凉州词二首</a>
						           <a href="#/primary1" class="tag">成都曲</a>
						           <a href="#/primary1" class="tag">十七日观潮</a>
						           <a href="#/primary1" class="tag">醉蓬莱</a>
						           <a href="#/primary1" class="tag">夏日绝句</a>
						           <a href="#/primary1" class="tag">李清照</a>
						           <a href="#/primary1" class="tag">真州绝句</a>
						           <a href="#/primary1" class="tag">曹雪芹</a>
						           <a href="#/primary1" class="tag">丁洲怀古</a>
						           <a href="#/primary1" class="tag">关汉卿</a>
						           <a href="#/primary1" class="tag">四愁诗</a>
						           <a href="#/primary1" class="tag">三都赋</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn" round type="mini" @click="tochangjiang">长江</el-button>
						<el-button class="btn" round type="mini" @click="tohuanghe">黄河</el-button>
						<el-button class="btn" round type="mini" @click="todiming">地名</el-button>
						<el-button class="btn" round type="mini" @click="toshanshui">山水</el-button>
						<el-button class="btn" round type="mini" @click="totianyuan">田园</el-button>
						<el-button class="btn" round type="mini" @click="toxiejing">写景</el-button>
						<el-button class="btn" round type="mini" @click="toliushu">柳树</el-button>
						<el-button class="btn" round type="mini" @click="toyueliang">月亮</el-button>
						<el-button class="btn" round type="mini" @click="toma">马</el-button>
						<el-button class="btn" round type="mini" @click="toniao">鸟</el-button>
						<el-button class="btn" round type="mini" @click="tofeng">风</el-button>
						<el-button class="btn" round type="mini" @click="toxue">雪</el-button>
						<el-button class="btn" round type="mini" @click="toyu">雨</el-button>
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
					</div>
					<div id="search">
				...
				<h2 style="display: inline-block;">地名</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		tochangjiang:function(){
			this.$router.push('./changjiang')
		},
		todiming:function(){
			this.$router.push('./diming')
		},
		tofeng:function(){
			this.$router.push('./feng')
		},
		tohua:function(){
			this.$router.push('./hua')
		},
		tohuanghe:function(){
			this.$router.push('./huanghe')
		},
		toliushu:function(){
			this.$router.push('./liushu')
		},
		toma:function(){
			this.$router.push('./ma')
		},
		toniao:function(){
			this.$router.push('./niao')
		},
		toshanshui:function(){
			this.$router.push('./shanshui')
		},
		totianyuan:function(){
			this.$router.push('./tianyuan')
		},
		toxiejing:function(){
			this.$router.push('./xiejing')
		},
		toxue:function(){
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/地名.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
