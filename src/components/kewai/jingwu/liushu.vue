	...
	<div>
		<section class="mainbox">
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">柳树</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/柳树.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
