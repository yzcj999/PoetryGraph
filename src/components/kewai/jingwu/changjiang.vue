	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">晴江秋望</a>
						            <a href="#/primary1" class="tag">江上阻风</a>
						            <a href="#/primary1" class="tag">金陵望汉江</a>
						            <a href="#/primary1" class="tag">渡荆门送别</a>
						            <a href="#/primary1" class="tag">望天门山</a>
						            <a href="#/primary1" class="tag">崔季卿</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">春别曲</a>
						            <a href="#/primary1" class="tag">梅雨</a>
						            <a href="#/primary1" class="tag">张籍</a>
						            <a href="#/primary1" class="tag">曾公亮</a>
						            <a href="#/primary1" class="tag">李之仪</a>
						            <a href="#/primary1" class="tag">张孝祥</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">长江</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/长江.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
