	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">空城雀</a>
						            <a href="#/primary1" class="tag">早雁</a>
						            <a href="#/primary1" class="tag">归燕诗</a>
						            <a href="#/primary1" class="tag">咏雁</a>
						            <a href="#/primary1" class="tag">咏鸟</a>
						            <a href="#/primary1" class="tag">归雁</a>
						            <a href="#/primary1" class="tag">杜鹃行</a>
						            <a href="#/primary1" class="tag">闻黄鹂</a>
						            <a href="#/primary1" class="tag">柳宗元</a>
						            <a href="#/primary1" class="tag">野田黄雀行</a>
						            <a href="#/primary1" class="tag">杜牧</a>
						            <a href="#/primary1" class="tag">流莺</a>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">鸟</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/鸟.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
