	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">梅雨</a>
						            <a href="#/primary1" class="tag">春夜喜雨</a>
						            <a href="#/primary1" class="tag">晨雨</a>
						            <a href="#/primary1" class="tag">长安夜雨</a>
						            <a href="#/primary1" class="tag">微雨夜行</a>
						            <a href="#/primary1" class="tag">雨过山村</a>
						            <a href="#/primary1" class="tag">清平乐·咏雨</a>
						            <a href="#/primary1" class="tag">山雨</a>
						            <a href="#/primary1" class="tag">夏日杂诗</a>
						            <a href="#/primary1" class="tag">喜雨亭记</a>
						            <a href="#/primary1" class="tag">春游湖</a>
						            <a href="#/primary1" class="tag">虞美人·梳楼</a>
						            <a href="#/primary1" class="tag">晚归遇雨</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">雨</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/雨.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
