	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">春江花月夜</a>
						            <a href="#/primary1" class="tag">春山夜月</a>
						            <a href="#/primary1" class="tag">江楼月</a>
						            <a href="#/primary1" class="tag">静夜思</a>
						            <a href="#/primary1" class="tag">古朗月行</a>
						            <a href="#/primary1" class="tag">月圆</a>
						            <a href="#/primary1" class="tag">蝶恋花·早行</a>
						            <a href="#/primary1" class="tag">月出</a>
						            <a href="#/primary1" class="tag">香菱咏月</a>
						            <a href="#/primary1" class="tag">杨万里</a>
						            <a href="#/primary1" class="tag">王昌龄</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">霜月</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">月亮</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/月亮.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
