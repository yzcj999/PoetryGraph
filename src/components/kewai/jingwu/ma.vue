	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">紫骝马</a>
						            <a href="#/primary1" class="tag">病马</a>
						            <a href="#/primary1" class="tag">瘦马图</a>
						            <a href="#/primary1" class="tag">马说</a>
						            <a href="#/primary1" class="tag">发白马</a>
						            <a href="#/primary1" class="tag">李贺</a>
						            <a href="#/primary1" class="tag">韩愈</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">杜甫</a>
						            <a href="#/primary1" class="tag">刘彻</a>
						            <a href="#/primary1" class="tag">天马二首</a>
						            <a href="#/primary1" class="tag">白驹</a>
						            <a href="#/primary1" class="tag">书韩干牧马图</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">马</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/马.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
