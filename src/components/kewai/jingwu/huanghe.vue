	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">书河上亭壁</a>
						           <a href="#/primary1" class="tag">渡黄河</a>
						           <a href="#/primary1" class="tag">黄河夜泊</a>
						           <a href="#/primary1" class="tag">黄河</a>
						           <a href="#/primary1" class="tag">浪淘沙·其一</a>
						           <a href="#/primary1" class="tag">刘禹锡</a>
						           <a href="#/primary1" class="tag">高适</a>
						           <a href="#/primary1" class="tag">公无渡河</a>
						           <a href="#/primary1" class="tag">宋琬</a>
						           <a href="#/primary1" class="tag">黄河行</a>
						           <a href="#/primary1" class="tag">贡泰父</a>
						           <a href="#/primary1" class="tag">谢榛</a>
						           <a href="#/primary1" class="tag">范云</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">黄河</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/黄河.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
