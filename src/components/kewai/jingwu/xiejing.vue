	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">夜雨寄北</a>
						           <a href="#/primary1" class="tag">春晓</a>
						           <a href="#/primary1" class="tag">望洞庭</a>
						           <a href="#/primary1" class="tag">江南春</a>
						           <a href="#/primary1" class="tag">秋夕</a>
						           <a href="#/primary1" class="tag">黄鹤楼</a>
						           <a href="#/primary1" class="tag">登鹳雀楼</a>
						           <a href="#/primary1" class="tag">咏柳</a>
						           <a href="#/primary1" class="tag">题西林壁</a>
						           <a href="#/primary1" class="tag">题临安邸</a>
						           <a href="#/primary1" class="tag">望庐山瀑布</a>
						           <a href="#/primary1" class="tag">独坐敬亭山</a>
						           <a href="#/primary1" class="tag">鹿柴</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">写景</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/写景.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
