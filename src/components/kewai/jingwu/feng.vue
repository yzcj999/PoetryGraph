	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">秋风引</a>
						            <a href="#/primary1" class="tag">军城早秋</a>
						            <a href="#/primary1" class="tag">严武</a>
						            <a href="#/primary1" class="tag">初夏即事</a>
						            <a href="#/primary1" class="tag">春风</a>
						            <a href="#/primary1" class="tag">野步</a>
						            <a href="#/primary1" class="tag">扫花游·秋声</a>
						            <a href="#/primary1" class="tag">风赋</a>
						            <a href="#/primary1" class="tag">春思</a>
						            <a href="#/primary1" class="tag">南风歌</a>
						            <a href="#/primary1" class="tag">北风</a>
						            <a href="#/primary1" class="tag">落日忆山中</a>
						            <a href="#/primary1" class="tag">咏风</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">风</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/风.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
