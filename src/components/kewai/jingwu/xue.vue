	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						           <a href="#/primary1" class="tag">对雪</a>
						           <a href="#/primary1" class="tag">春雪</a>
						           <a href="#/primary1" class="tag">望雪</a>
						           <a href="#/primary1" class="tag">蟾宫曲·雪</a>
						           <a href="#/primary1" class="tag">落梅风·咏雪</a>
						           <a href="#/primary1" class="tag">清平乐·雪</a>
						           <a href="#/primary1" class="tag">除夜雪</a>
						           <a href="#/primary1" class="tag">雪梅</a>
						           <a href="#/primary1" class="tag">钓雪亭</a>
						           <a href="#/primary1" class="tag">咏雪</a>
						           <a href="#/primary1" class="tag">雪里梅花诗</a>
						           <a href="#/primary1" class="tag">雪赋</a>
						           <a href="#/primary1" class="tag">洛阳春·雪</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">雪</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/雪.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
