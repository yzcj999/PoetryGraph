	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">望洞庭</a>
						            <a href="#/primary1" class="tag">滁州西涧</a>
						            <a href="#/primary1" class="tag">过故人庄</a>
						            <a href="#/primary1" class="tag">钱塘湖春行</a>
						            <a href="#/primary1" class="tag">咏鹅</a>
						            <a href="#/primary1" class="tag">望岳</a>
						            <a href="#/primary1" class="tag">滕王阁序</a>
						            <a href="#/primary1" class="tag">夏日山中</a>
						            <a href="#/primary1" class="tag">游黄檗山</a>
						            <a href="#/primary1" class="tag">山中杂诗</a>
						            <a href="#/primary1" class="tag">与朱元思书</a>
						            <a href="#/primary1" class="tag">三峡</a>
						            <a href="#/primary1" class="tag">玉楼春</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">山水</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/山水.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
