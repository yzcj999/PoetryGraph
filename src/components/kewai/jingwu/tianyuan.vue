	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">首春逢耕者</a>
						            <a href="#/primary1" class="tag">春晚书山家</a>
						            <a href="#/primary1" class="tag">稻田</a>
						            <a href="#/primary1" class="tag">过故人庄</a>
						            <a href="#/primary1" class="tag">山行</a>
						            <a href="#/primary1" class="tag">南园十三首</a>
						            <a href="#/primary1" class="tag">春庄</a>
						            <a href="#/primary1" class="tag">过山农家</a>
						            <a href="#/primary1" class="tag">采莲词</a>
						            <a href="#/primary1" class="tag">落日</a>
						            <a href="#/primary1" class="tag">陆浑山庄</a>
						            <a href="#/primary1" class="tag">春中田园作</a>
						            <a href="#/primary1" class="tag">张谷田舍</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">田园</h2>
				<div id="zoombtn">
...
export default{
    ...
    tohua:function(){
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/田园.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
