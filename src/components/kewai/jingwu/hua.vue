	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">野菊</a>
						            <a href="#/primary1" class="tag">腊前月季</a>
						            <a href="#/primary1" class="tag">春日</a>
						            <a href="#/primary1" class="tag">牡丹吟</a>
						            <a href="#/primary1" class="tag">善赏花吟</a>
						            <a href="#/primary1" class="tag">嗅梅</a>
						            <a href="#/primary1" class="tag">咏石榴花</a>
						            <a href="#/primary1" class="tag">看梅绝句</a>
						            <a href="#/primary1" class="tag">落花</a>
						            <a href="#/primary1" class="tag">卜算子·兰</a>
						            <a href="#/primary1" class="tag">蜡梅</a>
						            <a href="#/primary1" class="tag">杏花</a>
						            <a href="#/primary1" class="tag">陆游</a>
						</div>
					</div>
				</div>
            ...
            <el-button class="btn" round type="mini" @click="tohua">花</el-button>
				...
				<h2 style="display: inline-block;">花</h2>
				<div id="zoombtn">
    ...
    tuhua:function(){
      this.$router.push('/hua')
		...
		initGraph(){
					...
					d3.json("static/json/kewai/jingwu/花.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
