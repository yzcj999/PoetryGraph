	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">饮酒</a>
						            <a href="#/primary1" class="tag">桃花源记</a>
						            <a href="#/primary1" class="tag">庄周</a>
						            <a href="#/primary1" class="tag">北冥有鱼</a>
						            ...
						            <a href="#/primary1" class="tag">崔颢</a>
						            <a href="#/primary1" class="tag">黄鹤楼</a>
						            <a href="#/primary1" class="tag">李白</a>
						            <a href="#/primary1" class="tag">送友人</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">初二</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/chuzhong/初二.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
