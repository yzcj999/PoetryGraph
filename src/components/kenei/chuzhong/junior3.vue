	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">范仲淹</a>
						            <a href="#/primary1" class="tag">岳阳楼记</a>
						            <a href="#/primary1" class="tag">文天祥</a>
						            <a href="#/primary1" class="tag">过零丁洋</a>
						            <a href="#/primary1" class="tag">辛弃疾</a>
						            <a href="#/primary1" class="tag">破阵子</a>
						            <a href="#/primary1" class="tag">欧阳修</a>
						            <a href="#/primary1" class="tag">醉翁亭记</a>
						            <a href="#/primary1" class="tag">诸葛亮</a>
						            <a href="#/primary1" class="tag">出师表</a>
						            <a href="#/primary1" class="tag">纳兰性德</a>
						            <a href="#/primary1" class="tag">浣溪沙</a>
						            <a href="#/primary1" class="tag">鱼我所欲也</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn active" round type="mini" @click="toJonior1">初一</el-button>
						<el-button class="btn" round type="mini" @click="toJonior2">初二</el-button>
						<el-button class="btn" round type="mini" @click="toJonior3">初三</el-button>
					</div>
					<div id="search">
				...
				<h2 style="display: inline-block;">初三</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		toJonior1:function(){
			this.$router.push('./junior1')
		},
		toJonior2:function(){
			this.$router.push('./junior2')
		},
		toJonior3:function(){
			this.$router.push('./junior3')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kenei/chuzhong/初三.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
