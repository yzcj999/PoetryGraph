	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
						<h2>动态词云图</h2>
						<div id="wrap">
						            <a href="#/primary1" class="tag">木兰诗</a>
						            <a href="#/primary1" class="tag">杜甫</a>
						            <a href="#/primary1" class="tag">望岳</a>
						            <a href="#/primary1" class="tag">刘禹锡</a>
						            <a href="#/primary1" class="tag">陋室铭</a>
						            <a href="#/primary1" class="tag">龚自珍</a>
						            <a href="#/primary1" class="tag">乙亥杂诗</a>
						            <a href="#/primary1" class="tag">陆游</a>
						            <a href="#/primary1" class="tag">乙亥杂诗</a>
						            <a href="#/primary1" class="tag">周敦颐</a>
						            <a href="#/primary1" class="tag">爱莲说</a>
          ...
          <el-button class="btn" round type="mini" @click="toJonior3">初三</el-button>
				...
				<h2 style="display: inline-block;">初一</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/chuzhong/初一.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
