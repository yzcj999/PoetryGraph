	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">游兰溪</a>
						            <a href="#/primary1" class="tag">杜甫</a>
						            <a href="#/primary1" class="tag">登岳阳楼</a>
						            <a href="#/primary1" class="tag">旅夜书怀</a>
						            <a href="#/primary1" class="tag">鲍照</a>
						            <a href="#/primary1" class="tag">拟行路难</a>
						            <a href="#/primary1" class="tag">狱中杂记</a>
						            <a href="#/primary1" class="tag">屈原</a>
						            <a href="#/primary1" class="tag">湘夫人</a>
						            <a href="#/primary1" class="tag">司马迁</a>
						            <a href="#/primary1" class="tag">项羽之死</a>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
						<el-button class="btn active" round type="mini" @click="toHigh1">必修</el-button>
						<el-button class="btn" round type="mini" @click="toHigh2">选修</el-button>
						<el-button class="btn" round type="mini" @click="toHigh3">中国古代诗歌散文赏析（选修）</el-button>
          </div>
					<div id="search">
				...
				<h2 style="display: inline-block;">中国古代诗歌散文赏析（选修）</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		toHigh1:function(){
			this.$router.push('./high1')
		},
		toHigh2:function(){
			this.$router.push('./high2')
		},
		toHigh3:function(){
			this.$router.push('./high3')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kenei/gaozhong/选修.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
