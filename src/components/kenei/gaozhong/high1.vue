	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">鸿门宴</a>
						            <a href="#/primary1" class="tag">杜甫</a>
						            <a href="#/primary1" class="tag">登高</a>
						            <a href="#/primary1" class="tag">陶渊明</a>
						            <a href="#/primary1" class="tag">归园田居</a>
						            <a href="#/primary1" class="tag">荀子</a>
						            <a href="#/primary1" class="tag">劝学</a>
						            <a href="#/primary1" class="tag">苏轼</a>
						            <a href="#/primary1" class="tag">赤壁赋</a>
						            <a href="#/primary1" class="tag">韩愈</a>
						            <a href="#/primary1" class="tag">师说</a>
            ...
            <el-button class="btn" round type="mini" @click="toHigh3">中国古代诗歌散文赏析（选修）</el-button>
				...
				<h2 style="display: inline-block;">必修</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/gaozhong/必修一.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
