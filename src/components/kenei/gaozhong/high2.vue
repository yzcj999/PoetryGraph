	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">将进酒</a>
						            <a href="#/primary1" class="tag">蜀道难</a>
						            <a href="#/primary1" class="tag">屈原</a>
						            <a href="#/primary1" class="tag">离骚</a>
						            <a href="#/primary1" class="tag">陈情表</a>
						            <a href="#/primary1" class="tag">礼记</a>
						            <a href="#/primary1" class="tag">苏武传</a>
						            <a href="#/primary1" class="tag">王羲之</a>
						            <a href="#/primary1" class="tag">兰亭集序</a>
						            <a href="#/primary1" class="tag">李商隐</a>
						            <a href="#/primary1" class="tag">锦瑟</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">选修</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/gaozhong/必修二.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
