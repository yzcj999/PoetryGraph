	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">孟郊</a>
                        <a href="#/primary1" class="tag">游子吟</a>
                        <a href="#/primary1" class="tag">纳兰性德</a>
                        <a href="#/primary1" class="tag">长相思</a>
                        <a href="#/primary1" class="tag">朱熹</a>
                        <a href="#/primary1" class="tag">观书有感</a>
                        <a href="#/primary1" class="tag">王昌龄</a>
                        <a href="#/primary1" class="tag">从军行七首</a>
                        <a href="#/primary1" class="tag">王之涣</a>
                        <a href="#/primary1" class="tag">凉州词</a>
                        <a href="#/primary1" class="tag">清代</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">五年级</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/xiaoxue/五年级.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
