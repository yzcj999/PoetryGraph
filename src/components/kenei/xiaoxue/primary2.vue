	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">小儿垂钓</a>
						            <a href="#/primary1" class="tag">绝句</a>
						            ...
						            <a href="#/primary1" class="tag">江雪</a>
						            <a href="#/primary1" class="tag">王安石</a>
						            <a href="#/primary1" class="tag">梅花</a>
						            <a href="#/primary1" class="tag">小儿垂钓</a>
						            <a href="#/primary1" class="tag">胡令能</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">二年级</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/xiaoxue/二年级.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
