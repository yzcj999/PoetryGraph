	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">韩非</a>
						            <a href="#/primary1" class="tag">白居易</a>
						            <a href="#/primary1" class="tag">宋代</a>
						            <a href="#/primary1" class="tag">忆江南</a>
						            <a href="#/primary1" class="tag">九月九日忆山东兄弟</a>
						            <a href="#/primary1" class="tag">采莲曲</a>
						            <a href="#/primary1" class="tag">早发白帝城</a>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">三年级</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/xiaoxue/三年级.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
