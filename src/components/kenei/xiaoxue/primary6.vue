	...
	<div>
		<section class="mainbox">
			<div class="column">
				<div class="ciyun">
					<div class="chart">
                        ...
                        <a href="#/primary1" class="tag">浪淘沙</a>
                        <a href="#/primary1" class="tag">七律.长征</a>
                        <a href="#/primary1" class="tag">先秦</a>
			...
			<div class="column">
				<div class="btnlist">
					<div id="leibie">
					<el-button class="btn active" round type="mini" @click="toPrimary1">一年级</el-button>
					<el-button class="btn" round type="mini" @click="toPrimary2">二年级</el-button>
					<el-button class="btn" round type="mini" @click="toPrimary3">三年级</el-button>
					<el-button class="btn" round type="mini" @click="toPrimary4">四年级</el-button>
					<el-button class="btn" round type="mini" @click="toPrimary5">五年级</el-button>
					<el-button class="btn" round type="mini" @click="toPrimary6">六年级</el-button>
					</div>
					<div id="search">
				...
				<h2 style="display: inline-block;">六年级</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		toPrimary1:function(){
			this.$router.push('./primary1')
		},
		toPrimary2:function(){
			this.$router.push('./primary2')
		},
		toPrimary3:function(){
			this.$router.push('./primary3')
		},
		toPrimary4:function(){
			this.$router.push('./primary4')
		},
		toPrimary5:function(){
			this.$router.push('./primary5')
		},
		toPrimary6:function(){
			this.$router.push('./primary6')
		},
		initGraph(){
					var shuju;
					var lastFocusNode;
					...
					d3.json("static/json/kenei/xiaoxue/六年级.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
