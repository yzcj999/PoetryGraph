	...
	<div>
		<section class="mainbox">
				...
				<div class="ciyun">
					<div class="chart">
						...
						<div id="wrap">
						            ...
						            <a href="#/primary1" class="tag">清平乐.村居</a>
						            <a href="#/primary1" class="tag">夏日绝句</a>
						            <a href="#/primary1" class="tag">塞下曲</a>
						</div>
					</div>
				</div>
			...
			<div class="column">
				...
				<h2 style="display: inline-block;">四年级</h2>
				<div id="zoombtn">
...
export default{
	...
	methods:{
		...
		initGraph(){
					...
					d3.json("static/json/kenei/xiaoxue/四年级.json",function(error,data){
						shuju=data
						console.log(data)
						init(data)
